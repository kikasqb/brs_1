...
/**
 * Created by PCCuong on 2/14/2017.
 */
...
public class PasswordEditText extends EditText {
    ...
    private void khoitao(AttributeSet attrs) {
        ...
        this.eye = ContextCompat.getDrawable(getContext(), R.drawable.ic_visibility_black_24dp).mutate();
        this.eyeStrike = ContextCompat.getDrawable(getContext(), R.drawable.ic_visibility_off_black_24dp).mutate();
        caidat();
    }
